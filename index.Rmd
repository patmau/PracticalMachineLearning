...
The accuracies on the test set are only slightly below the in-sample accuracy, with `r percent(cm.rf$overall[1])` for RF and `r percent(cm.lda$overall[1])` for LDA. Again, RF performance is excellent.
`r cm.rf$overall[1]^20` for 20 correct and `r cm.rf$overall[1] * 20` wrong in 20.
